...
abstract contract CToken_VCNote is CTokenInterface, ExponentialNoError, TokenErrorReporter {
     ...
     */
    function mintInternal(uint mintAmount) virtual internal nonReentrant {
        accrueInterest();
     ...
     */
    function redeemInternal(uint redeemTokens) virtual internal nonReentrant {
        accrueInterest();
     ...
     */
    function redeemUnderlyingInternal(uint redeemAmount) virtual internal nonReentrant {
        accrueInterest();
        // redeemFresh emits redeem-specific logs on errors, so we don't need to
